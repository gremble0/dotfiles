...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(term-color-red ((,class (:background ,bad :foreground ,bad))))
   `(term-color-green ((,class (:background ,str :foreground ,str))))
   `(term-color-yellow ((,class (:background ,func :foreground ,func))))
   `(term-color-blue ((,class (:background ,directory :foreground ,directory))))
   `(term-color-magenta ((,class (:background ,var :foreground ,var))))
   `(term-color-cyan ((,class (:background ,link :foreground ,link))))
   ...
   `(helm-ff-invalid-symlink ((,class (:foreground ,bad :background ,bg1 :weight bold))))
