...
(custom-set-variables
 ...
 '(package-selected-packages
   '(which-key vterm-toggle vertico rainbow-mode orderless mood-line marginalia magit lua-mode lsp-mode highlight-indent-guides git-gutter general geiser-chez evil-collection eshell-syntax-highlighting eros corfu consult)))
(custom-set-faces
